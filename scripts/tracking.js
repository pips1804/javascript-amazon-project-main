...
async function loadPage() {
  ...
  const product = getProduct(producId);

  // This will get additional details for the order
  // like estimated delivery time
  let productDetails;
  ...
  // This will calculate the percent progress delivery
  const today = dayjs();
